...
file = open("CROHME_extractor-master/CROHME_extractor-master/outputs/test/test.pickle", 'rb')
...
while pos != len(pickle_file):
    if pickle_file[pos]["label"][label] == 1:
        ...
        cv2.imwrite(f"datasets/clarencezhao_sagyamthapa/test/{pos}.jpg", image)
