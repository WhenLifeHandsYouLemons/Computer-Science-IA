...
batch_size = 64 # Possible nice batch numbers: 10*10*5*131 (used 50 last time)
...
def test(dataloader, model, loss_fn):
    ...
    if correct >= max(corrects):
        PATH = "trained_models/2_layer_conv_model.pth"
